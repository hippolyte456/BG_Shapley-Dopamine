...
public:
    ...
    void record_targets() {
        ...
        if(this->record__sum_exc && ( (t - this->offset_) % this->period_ == this->period_offset_ )){
            if(!this->partial)
                this->_sum_exc.push_back(pop22._sum_exc);
            else{
                std::vector<double> tmp = std::vector<double>();
                for (unsigned int i=0; i<this->ranks.size(); i++){
                    tmp.push_back(pop22._sum_exc[this->ranks[i]]);
                }
                this->_sum_exc.push_back(tmp);
            }
        }
        if(this->record__sum_inh && ( (t - this->offset_) % this->period_ == this->period_offset_ )){
            if(!this->partial)
                this->_sum_inh.push_back(pop22._sum_inh);
            else{
                std::vector<double> tmp = std::vector<double>();
                for (unsigned int i=0; i<this->ranks.size(); i++){
                    tmp.push_back(pop22._sum_inh[this->ranks[i]]);
                }
                this->_sum_inh.push_back(tmp);
            }
        }
...
class ProjRecorder85 : public Monitor
{
protected:
    ProjRecorder85(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder85 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj85.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder85(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder85 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder85* get_instance(int id) {
        return static_cast<ProjRecorder85*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor85::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder86 : public Monitor
{
protected:
    ProjRecorder86(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder86 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj86.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder86(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder86 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder86* get_instance(int id) {
        return static_cast<ProjRecorder86*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor86::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder87 : public Monitor
{
protected:
    ProjRecorder87(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder87 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj87.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder87(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder87 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder87* get_instance(int id) {
        return static_cast<ProjRecorder87*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor87::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder88 : public Monitor
{
protected:
    ProjRecorder88(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder88 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj88.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder88(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder88 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder88* get_instance(int id) {
        return static_cast<ProjRecorder88*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor88::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder89 : public Monitor
{
protected:
    ProjRecorder89(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder89 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj89.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder89(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder89 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder89* get_instance(int id) {
        return static_cast<ProjRecorder89*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor89::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder90 : public Monitor
{
protected:
    ProjRecorder90(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder90 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj90.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder90(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder90 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder90* get_instance(int id) {
        return static_cast<ProjRecorder90*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor90::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder91 : public Monitor
{
protected:
    ProjRecorder91(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder91 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj91.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder91(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder91 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder91* get_instance(int id) {
        return static_cast<ProjRecorder91*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor91::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder92 : public Monitor
{
protected:
    ProjRecorder92(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder92 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj92.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder92(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder92 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder92* get_instance(int id) {
        return static_cast<ProjRecorder92*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor92::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder93 : public Monitor
{
protected:
    ProjRecorder93(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder93 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj93.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder93(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder93 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder93* get_instance(int id) {
        return static_cast<ProjRecorder93*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor93::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder94 : public Monitor
{
protected:
    ProjRecorder94(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder94 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj94.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder94(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder94 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder94* get_instance(int id) {
        return static_cast<ProjRecorder94*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor94::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder95 : public Monitor
{
protected:
    ProjRecorder95(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder95 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj95.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder95(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder95 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder95* get_instance(int id) {
        return static_cast<ProjRecorder95*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor95::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder96 : public Monitor
{
protected:
    ProjRecorder96(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder96 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj96.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder96(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder96 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder96* get_instance(int id) {
        return static_cast<ProjRecorder96*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor96::clear(): not implemented for openMP paradigm." << std::endl;
    }


};

class ProjRecorder97 : public Monitor
{
protected:
    ProjRecorder97(std::vector<int> ranks, int period, int period_offset, long int offset)
        : Monitor(ranks, period, period_offset, offset)
    {
    #ifdef _DEBUG
        std::cout << "ProjRecorder97 (" << this << ") instantiated." << std::endl;
    #endif
        std::map< int, int > post_indices = std::map< int, int > ();
        auto post_rank = proj97.get_post_rank();
...
public:
    ...
    static int create_instance(std::vector<int> ranks, int period, int period_offset, long int offset) {
        auto new_recorder = new ProjRecorder97(ranks, period, period_offset, offset);
        auto id = addRecorder(static_cast<Monitor*>(new_recorder));
    #ifdef _DEBUG
        std::cout << "ProjRecorder97 (" << new_recorder << ") received list position (ID) = " << id << std::endl;
    #endif
        return id;
    }

    static ProjRecorder97* get_instance(int id) {
        return static_cast<ProjRecorder97*>(getRecorder(id));
    }
    ...
    void clear() {
        std::cout << "PopMonitor97::clear(): not implemented for openMP paradigm." << std::endl;
    }
