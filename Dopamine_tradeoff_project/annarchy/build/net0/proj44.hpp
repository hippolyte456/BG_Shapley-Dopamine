...
/////////////////////////////////////////////////////////////////////////////
// proj44: pop13 -> FSI with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct44 : LILMatrix<int, int> {
    ProjStruct44() : LILMatrix<int, int>( 10, 1) {
    }
    ...
    std::vector<std::vector<double>> get_local_attribute_all_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct44::get_local_attribute_all_double: " << name << " not found" << std::endl;
    ...
    std::vector<double> get_local_attribute_row_double(std::string name, int rk_post) {
        ...
        // should not happen
        std::cerr << "ProjStruct44::get_local_attribute_row_double: " << name << " not found" << std::endl;
    ...
    double get_local_attribute_double(std::string name, int rk_post, int rk_pre) {
        ...
        // should not happen
        std::cerr << "ProjStruct44::get_local_attribute: " << name << " not found" << std::endl;
        return 0.0;
    }
