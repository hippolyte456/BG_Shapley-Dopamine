...
/////////////////////////////////////////////////////////////////////////////
// proj41: pop0 -> GPiSNr with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct41 : LILMatrix<int, int> {
    ProjStruct41() : LILMatrix<int, int>( 2, 2) {
    }
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct41::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
