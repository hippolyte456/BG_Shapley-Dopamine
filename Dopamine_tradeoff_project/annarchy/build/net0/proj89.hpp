...
/////////////////////////////////////////////////////////////////////////////
// proj89: FSI -> MSNd1 with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct89 : LILMatrix<int, int> {
    ProjStruct89() : LILMatrix<int, int>( 10, 10) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct89::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct89::compute_psp()" << std::endl;
    #endif
        double sum;
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct89::update_synapse()" << std::endl;
    #endif
    ...
    std::vector<std::vector<double>> get_local_attribute_all_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct89::get_local_attribute_all_double: " << name << " not found" << std::endl;
    ...
    std::vector<double> get_local_attribute_row_double(std::string name, int rk_post) {
        ...
        // should not happen
        std::cerr << "ProjStruct89::get_local_attribute_row_double: " << name << " not found" << std::endl;
    ...
    double get_local_attribute_double(std::string name, int rk_post, int rk_pre) {
        ...
        // should not happen
        std::cerr << "ProjStruct89::get_local_attribute: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct89::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct89::clear() - this = " << this << std::endl;
    #endif
