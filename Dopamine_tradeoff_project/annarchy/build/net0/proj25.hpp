...
/////////////////////////////////////////////////////////////////////////////
// proj25: pop8 -> MSNd2 with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct25 : LILMatrix<int, int> {
    ProjStruct25() : LILMatrix<int, int>( 10, 1) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop23._active){
            ...
            std::vector<double> _pre_r = pop8._delayed_r[delay-1];
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct25::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
