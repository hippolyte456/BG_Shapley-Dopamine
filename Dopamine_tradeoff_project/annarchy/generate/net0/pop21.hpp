...
///////////////////////////////////////////////////////////////
// Main Structure for the population of id 21 (FSI)
///////////////////////////////////////////////////////////////
struct PopStruct21{
    ...
    // Local functions
    double f_activateFSI (double x) {return Smax_FSI/(exp((theta_FSI - x)/sigmap) + 1.0) ;};
    ...
    std::vector<double> get_local_attribute_all_double(std::string name) {
        ...
        // should not happen
        std::cerr << "PopStruct21::get_local_attribute_all_double: " << name << " not found" << std::endl;
    ...
    double get_local_attribute_double(std::string name, int rk) {
        ...
        // should not happen
        std::cerr << "PopStruct21::get_local_attribute_double: " << name << " not found" << std::endl;
    ...
    void set_local_attribute_all_double(std::string name, std::vector<double> value) {
        ...
        // should not happen
        std::cerr << "PopStruct21::set_local_attribute_all_double: " << name << " not found" << std::endl;
    }
    ...
    void set_local_attribute_double(std::string name, int rk, double value) {
        ...
        // should not happen
        std::cerr << "PopStruct21::set_local_attribute_double: " << name << " not found" << std::endl;
    }
    ...
    #ifdef _DEBUG
        std::cout << "PopStruct21::init_population() - this = " << this << std::endl;
    #endif
        _active = true;
    ...
    std::cout << "    PopStruct21::update_rng()" << std::endl;
#endif
    ...
    void update() {
        ...
        if( _active ) {
        #ifdef _TRACE_SIMULATION_STEPS
            std::cout << "    PopStruct21::update()" << std::endl;
        #endif
    ...
    void clear() {
#ifdef _DEBUG
    std::cout << "PopStruct21::clear() - this = " << this << std::endl;
#endif
        // Variables
        mp.clear();
        mp.shrink_to_fit();
