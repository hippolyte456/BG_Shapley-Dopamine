...
/////////////////////////////////////////////////////////////////////////////
// proj21: MSNd2 -> MSNd2 with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct21 : LILMatrix<int, int> {
    ProjStruct21() : LILMatrix<int, int>( 2, 2) {
    }
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct21::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
