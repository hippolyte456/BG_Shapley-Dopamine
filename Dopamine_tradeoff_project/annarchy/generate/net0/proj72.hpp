...
/////////////////////////////////////////////////////////////////////////////
// proj72: MSNd1 -> GPiSNr with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct72 : LILMatrix<int, int> {
    ProjStruct72() : LILMatrix<int, int>( 10, 10) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct72::init_projection() - this = " << this << std::endl;
    #endif
    ...
    void compute_psp() {
        ...
        std::cout << "    ProjStruct72::compute_psp()" << std::endl;
    #endif
        double sum;

        if (_transmission && pop25._active){

            std::vector<double> _pre_r = pop22._delayed_r[delay-1];
            ...
            for (int i = 0; i < post_rank.size(); i++) {
                ...
                pop25._sum_inh[post_rank[i]] += sum;
            }
    ...
    void update_synapse() {
    #ifdef _TRACE_SIMULATION_STEPS
        std::cout << "    ProjStruct72::update_synapse()" << std::endl;
    #endif
    ...
    std::vector<std::vector<double>> get_local_attribute_all_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct72::get_local_attribute_all_double: " << name << " not found" << std::endl;
    ...
    std::vector<double> get_local_attribute_row_double(std::string name, int rk_post) {
        ...
        // should not happen
        std::cerr << "ProjStruct72::get_local_attribute_row_double: " << name << " not found" << std::endl;
    ...
    double get_local_attribute_double(std::string name, int rk_post, int rk_pre) {
        ...
        // should not happen
        std::cerr << "ProjStruct72::get_local_attribute: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct72::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
    ...
    void clear() {
    #ifdef _DEBUG
        std::cout << "ProjStruct72::clear() - this = " << this << std::endl;
    #endif
