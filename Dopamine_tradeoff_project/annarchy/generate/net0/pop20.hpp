...
///////////////////////////////////////////////////////////////
// Main Structure for the population of id 20 (pop20)
///////////////////////////////////////////////////////////////
struct PopStruct20{
    ...
    std::vector<double> get_local_attribute_all_double(std::string name) {
        ...
        // should not happen
        std::cerr << "PopStruct20::get_local_attribute_all_double: " << name << " not found" << std::endl;
    ...
    double get_local_attribute_double(std::string name, int rk) {
        ...
        // should not happen
        std::cerr << "PopStruct20::get_local_attribute_double: " << name << " not found" << std::endl;
    ...
    void set_local_attribute_all_double(std::string name, std::vector<double> value) {
        ...
        // should not happen
        std::cerr << "PopStruct20::set_local_attribute_all_double: " << name << " not found" << std::endl;
    }
    ...
    void set_local_attribute_double(std::string name, int rk, double value) {
        ...
        // should not happen
        std::cerr << "PopStruct20::set_local_attribute_double: " << name << " not found" << std::endl;
    }
    ...
    #ifdef _DEBUG
        std::cout << "PopStruct20::init_population() - this = " << this << std::endl;
    #endif
        _active = true;
    ...
    std::cout << "    PopStruct20::update_rng()" << std::endl;
#endif
    ...
    void clear() {
#ifdef _DEBUG
    std::cout << "PopStruct20::clear() - this = " << this << std::endl;
#endif
        // Variables
        r.clear();
        r.shrink_to_fit();
